...
export const translations = {
  en: {
    ...
    "apiKey.settings.desc": "You are using your own Gemini key for unlimited analyses.",
  ...
  pt: {
    ...
    "apiKey.settings.desc": "Você está usando sua própria chave para consultas ilimitadas.",
