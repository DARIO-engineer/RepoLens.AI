...
export const translations = {
  en: {
    ...
    "form.validation": "Enter username/repository (or https://github.com/username/repository).",
    ...
    "apiKey.modal.info": "To continue using RepoLens AI, add your own Google Gemini API key. It's 100% free and easy to get!",
    "apiKey.modal.label": "Your Gemini API Key",
    "apiKey.modal.placeholder": "Paste your API key here...",
    "apiKey.modal.help": "How to get a free API key?",
    ...
    "repo.validation.invalidFormat": "Invalid format. Use 'username/repository' or 'https://github.com/username/repository'.",
    "repo.validation.notFound": "Repository was not found on GitHub.",
    "repo.validation.forbidden": "Unable to validate repository right now (GitHub API limit).",
  ...
  pt: {
    ...
    "form.validation": "Insira usuario/repositorio (ou https://github.com/usuario/repositorio).",
    ...
    "apiKey.modal.info": "Para continuar usando o RepoLens AI, adicione sua própria chave do Google Gemini. É 100% grátis e fácil de obter!",
    "apiKey.modal.label": "Sua API Key do Gemini",
    "apiKey.modal.placeholder": "Cole sua chave aqui...",
    "apiKey.modal.help": "Como obter uma chave grátis?",
    ...
    "repo.validation.invalidFormat": "Formato inválido. Use 'usuario/repositorio' ou 'https://github.com/usuario/repositorio'.",
    "repo.validation.notFound": "Repositório não encontrado no GitHub.",
    "repo.validation.forbidden": "Não foi possível validar o repositório agora (limite da API do GitHub).",
