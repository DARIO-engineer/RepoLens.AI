  ...
  return (
    <div className="min-h-screen bg-surface">
      ...
      <header className="border-b border-white/[0.06] glass sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3 flex items-center gap-4">
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <button
              onClick={toggleLang}
              className="flex items-center justify-center w-8 h-8 rounded-lg bg-white/[0.04] border border-white/[0.08] hover:border-primary/30 hover:bg-primary/5 transition-all cursor-pointer"
            ...
            <a
              ...
              className="flex items-center justify-center w-8 h-8 rounded-lg bg-white/[0.04] border border-white/[0.08] text-text-muted hover:text-[#0A66C2] hover:border-[#0A66C2]/30 transition-all"
              title="LinkedIn"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center w-8 h-8 rounded-lg bg-white/[0.04] border border-white/[0.08] text-text-muted hover:text-text hover:border-white/20 transition-all"
              title="GitHub"
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        {/* Error */}
        {error && (
          <div className="animate-fade-in max-w-3xl mx-auto mb-8 p-4 rounded-xl bg-danger/[0.08] border border-danger/15 text-danger text-sm backdrop-blur-sm">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-14">
          <div className="flex flex-col items-center gap-5">
            ...
            <div className="flex items-center gap-3">
              ...
              {/* LinkedIn — visible after 2026-02-16 15:10 BRT */}
              {Date.now() >= new Date("2026-02-16T15:10:00-03:00").getTime() && (
              <a href="https://www.linkedin.com/in/d%C3%A1rio-pimentel-5a03462ba" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-7 h-7 rounded-lg bg-white/[0.04] border border-white/[0.08] text-text-muted/50 hover:text-[#0A66C2] hover:border-[#0A66C2]/30 transition-all" title="LinkedIn">
                <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
              </a>
              )}
              <a href="https://github.com/DARIO-engineer" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-7 h-7 rounded-lg bg-white/[0.04] border border-white/[0.08] text-text-muted/50 hover:text-text hover:border-white/20 transition-all" title="GitHub">
