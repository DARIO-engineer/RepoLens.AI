      ...
      >
        <div className="relative p-8 sm:p-10">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-display font-bold text-text mb-2">Add your API Key</h2>
            <p className="text-text-muted text-sm">
              You've reached the limit of free analyses.
            </p>
          </div>

          <div className="bg-primary/[0.04] border border-primary/10 rounded-2xl p-4 mb-8">
            <p className="text-sm text-text-muted leading-relaxed">
              To continue using RepoLens AI, add your own Google Gemini API key. It's <strong>100% free</strong> and easy to get!
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              />
              {validationError && (
                <p className="text-danger text-xs mt-1 animate-fade-in">{validationError}</p>
              )}
            </div>
