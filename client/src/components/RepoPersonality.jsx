...
const ARCHETYPES = [
  {
    ...
    icon: (
      <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 2l3.5 3.5L12 9l-3.5-3.5L12 2z"></path>
        <path d="M12 9v13"></path>
        <path d="M12 22l-4-4"></path>
        <path d="M12 22l4-4"></path>
      </svg>
    ),
    color: "#6366f1",
...
const TRAIT_ICONS = {
  ...
  dormant: (
    <svg className="w-3 h-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M2 20a10 10 0 1 0 20 0H2z"></path>
    </svg>
  ),
  licensed: (
    <svg className="w-3 h-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                <div className="relative shrink-0">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div style={{ color: archetype.color, filter: `drop-shadow(0 0 12px ${archetype.color}60)` }}>
                      {archetype.icon}
                    </div>
                  </div>
                </div>
              ...
              <div className="rounded-lg bg-white/[0.03] border border-white/[0.06] p-3">
                <div className="flex items-start gap-2">
                  <svg className="w-3.5 h-3.5 mt-0.5 text-primary-light/60" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path>
                  </svg>
                ...
                {DIMENSION_KEYS.map((dimKey) => {
                  ...
                  return (
                    <div key={dimKey} className="group relative flex items-center gap-2">
                      <span className="text-[8px] font-bold w-5 text-center text-text-muted/60">{dimKey.slice(0, 3).toUpperCase()}</span>
                      ...
                      <div className="absolute bottom-full left-0 mb-2 px-3 py-2 rounded-lg bg-surface/95 border border-white/10 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none shadow-xl z-20 w-52">
                        <div className="flex items-center gap-2 mb-1">
                          <span style={{ color: archetype.color }}>{DIMENSION_ICONS[dimKey]}</span>
